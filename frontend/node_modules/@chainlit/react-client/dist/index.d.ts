...
declare const useChatMessages: () => {
    messages: IStep[];
    firstUserMessage: IStep | undefined;
};
...
declare const firstUserMessageState: recoil.RecoilState<IStep | undefined>;
